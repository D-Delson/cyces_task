...
urlpatterns = [
    ...
    path('product_search_results/', views.ProductSearchListView.as_view(), name='search_results'),
    ...
    path('category_search_results/', views.CategorySearchListView.as_view(), name='category_search_results'),
    ...
    path('subcategory_search_results/', views.SubCategorySearchListView.as_view(), name='subcategory_search_results'),
]